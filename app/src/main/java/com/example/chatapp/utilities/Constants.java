    ...
    public static HashMap<String, String> getRemoteMsgHeaders() {
        if (remoteMsgHeaders == null) {
            ...
            remoteMsgHeaders.put(
                    ...
                    "key=AAAAhEhBaeQ:APA91bHTt-hh-139giz-yCt_opYUuRNMVFkhYvPVJDq1YOYcokgyRPYVQhbpeEPaB45CoVAZmEzp3yqOwzAVUgXHOoc8WphquK01zDiwHqHGMR9nacmiW6k9kMiT98ZkU6ONOJftZB3a"
            );
            remoteMsgHeaders.put(
